...
public final class PartyMessage extends Message {
	...
	/**
	 * Compares the units contained in this message with the parameters to
	 * detect anomalies
	 * 
	 * @return None if the team is acceptable; a Some with a message otherwise
	 */
	public Optional<String> validateTeam(Function<String, Unit> realUnits, Iterable<Item> realItems,
	        Iterable<Modifier> mods) {
