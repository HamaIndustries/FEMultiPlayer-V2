...
public abstract class Item implements Serializable, Comparable<Item> {
	...
	public static Item getItem(String name) {
		if (name.equals("Vulnerary"))
			return HealingItem.VULNERARY.getCopy();
		if (name.equals("Concoction"))
			return HealingItem.CONCOCTION.getCopy();
		if (name.equals("Elixir"))
			return HealingItem.ELIXIR.getCopy();
		if (name.equals("Rise"))
			return new RiseTome();
	...
	@Override
	public int hashCode() {
		return ((name.hashCode() * 31 + id) * 31 + maxUses) * 31 + cost;
	}
	...
	public boolean equals(Object other) {
		if (other != null && other instanceof Item) {
			...
			if (o2.canEquals(this)) {
				return this.name.equals(o2.name) && this.id == o2.id && this.maxUses == o2.maxUses
				        && this.uses == o2.uses && this.cost == o2.cost;
			} else {
				return false;
			}
		} else {
