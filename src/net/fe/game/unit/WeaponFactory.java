...
public class WeaponFactory {
	...
	private static final List<String> mounted = Arrays.asList("Paladin", "Valkyrie", /* "Falconknight", */
	        "Ephraim", "Eirika", "Eliwood");

	/** The Constant armored. */
	private static final List<String> armored = Arrays.asList("General");

	/** The Constant fliers. */
	public static final List<String> fliers = Arrays.asList("Falconknight");
	...
	private static final class WeaponBuilder {
		...
		public Weapon build() {
			return new Weapon(name, maxUses, id, cost, type, mt, hit, crit, range, modifiers, effective, pref);
		}
	}
	...
	private final static class Static1Range implements Function<Statistics, List<Integer>>, Serializable {
		...
		@Override
		public List<Integer> apply(Statistics s) {
		...
		public boolean equals(Object o) {
			return o instanceof Static1Range && ((Static1Range) o).value == this.value;
		}
	...
	private final static class StaticRange implements Function<Statistics, List<Integer>>, Serializable {
		...
		@Override
		public boolean equals(Object o) {
			return o instanceof StaticRange && ((StaticRange) o).min == this.min && ((StaticRange) o).max == this.max;
		}
