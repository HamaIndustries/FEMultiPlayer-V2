...
public class UnitFactory {
	...
	/**
	 * Load units. Fails if [[WeaponFactory#loadWeapons]] has not been called
	 * yet.
	 */
	public static void loadUnits() {
		...
		while (in.hasNextLine()) {
			...
			int aid;
			if (name.equals("Eirika") || unitClass.name.equals("Valkyrie") || unitClass.name.equals("Falconknight")) {
				aid = 20 - con;
			...
			Statistics bases = new Statistics(hpBase, strBase, magBase, sklBase, spdBase, defBase, resBase, lckBase,
			        mov, con, aid);

			Statistics growths = new Statistics(hpGrowth, strGrowth, magGrowth, sklGrowth, spdGrowth, defGrowth,
			        resGrowth, lckGrowth, 0, 0, 0);
