...
public class Summon extends OverworldContext {
	...
	public static Unit generateSummon(Unit summoner) {
		...
		Statistics bases = new Statistics(/* hp = */ 1, /* str = */ 5,
		        /* mag = */ 0, /* skl = */ 2, /* spd = */ 4, /* def = */ 0,
		        /* res = */ 0, /* lck = */ 0, /* mov = */ 5, /* con = */ 11,
		        /* aid = */ 10);
		Statistics growths = new Statistics(/* hp = */ 0, /* str = */ 55,
		        /* mag = */ 15, /* skl = */ 35, /* spd = */ 45, /* def = */ 15,
		        /* res = */ 15, /* lck = */ 50, /* mov = */ 0, /* con = */ 0,
		        /* aid = */ 0);
		summonCount = summonCount + 1;
		final Unit summon = new Unit("Phantom " + summonCount, net.fe.game.unit.UnitClass.createClass("Phantom"), '-',
		        bases, growths);
