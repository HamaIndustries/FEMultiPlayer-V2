...
public class ObjectiveInfo extends Entity implements DoNotDestroy {
	...
	public void render() {
		...
		Renderer.drawBorderedRectangle(x, y, x + WIDTH, y + HEIGHT, renderDepth, FightStage.NEUTRAL,
		...
		for (Player p : s.getTurnOrder()) {
			...
			Renderer.drawString("default_med", units, x + WIDTH - unitsWidth - 8, ystart, renderDepth, t);
			ystart += 16;
		}
	}
}
