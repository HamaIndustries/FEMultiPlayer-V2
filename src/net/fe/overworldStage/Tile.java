...
public class Tile extends GriddedEntity implements DoNotDestroy {
	...
	/**
	 * P - Plain A - pAth M - Mountain ^ - Forest = - Wall S - Sea L - fLoor T -
	 * forT K - peaK I - pIllar D - Desert - - fence N - None V - Village O -
	 * thrOne (or castle entrance) C - Cliff ~ - Hill H - House.
	 */
	private static String terrainMap = "PPPPAAAAAAA----SSSS      " + "PPPPAAAAAAA----SSSS      "
	        + "PPPKKPAAA^^====SSSS      " + "MKKKAAAANNN====SSSS      " + "----AAAANVN==LSSS        "
	        + "NNNNNNNN^N^SLLSSS        " + "NVNNNNVN^V^SLLSSS        " + "KPKKKPPPAAAANNNNNNNNN    "
	        + "KPPPKPPPAAAANNNNNNNNN    " + "KKKKKPPPAAAANVNNONNON    " + "KKKKKAAAPPAAAAAHHSSSS    "
	        + "KKKKKAAAAAAAAPTHTSSSS    " + "KKKKKAAAAAAAANSSSSS      " + "KKKKKKKMMMMCCCSSSNNN     "
	        + "KKKKKPK^^^^CPCSSSNVN     " + "KKKKKPKKKKKKKCCC PA      " + "=======LL=P=LLSSS====    "
	        + "=======LL=P=LLSS======   " + "LLL====LLLPOLLSS=L=IOI   " + "LLLLLILLIILLLLSSSLLLLL   "
