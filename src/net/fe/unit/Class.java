...
public final class Class implements Serializable {
	 ...
	 */
	private Class(String name, String desc, int c, CombatTrigger m, List<? extends FieldSkill> fs, int sight, Weapon.Type... types){
		this.crit = c;
		this.masterSkill = m;
	...
	public static Class createClass(String name){
		...
		if(name.equals("Ike"))
			return new Class("Lord", 
					"A radiant hero who commands armies.",
					 0, new Aether(), Arrays.asList(new Shove(), new Smite()), 3,
		...
		if(name.equals("Assassin"))
			return new Class("Assassin", 
					...
					10, new Lethality(), Arrays.asList(new Shove()), 8,
					Weapon.Type.SWORD);
		...
		if(name.equals("Sage"))
			return new Class("Sage", 
					...
					0, new Sol(true), Arrays.asList(new Shove()), 3,
