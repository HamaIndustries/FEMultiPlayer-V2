	...
	public static Class createClass(String name){
		...
		if(name.equals("Roy"))
			return new Class("Lord", 
					...
					0,
					Arrays.asList(new Aether(), new ChargeSkillDefend(1, 0)),
		...
		if(name.equals("Eliwood"))
			return new Class("Lord", 
					"A courageous royal who commands armies.",
					 0,
					 Arrays.asList(new Sol(false), new ChargeSkillDefend(1, 0)),
					 emptyFieldSkillList,
					 3,
		...
		if(name.equals("Lyn"))
			return new Class("Lord", 
					"A serene youth who commands armies.",
					 0,
					 Arrays.asList(new Astra(), new ChargeSkillDefend(1, 0)),
					 Arrays.asList(new Shove()),
					 3,
		...
		if(name.equals("Hector"))
			return new Class("Lord", 
					"A mighty noble who commands armies.",
					 0,
					 Arrays.asList(new Luna(false), new ChargeSkillDefend(1, 0)),
		...
		if(name.equals("Sniper"))
			return new Class("Sniper", 
					...
					10,
					Arrays.asList(new Deadeye(), new ChargeSkillDefend(2, 0)),
					Arrays.asList(new Shove()),
					3,
		...
		if(name.equals("Berserker"))
			return new Class("Berserker",
					...
					10,
					Arrays.asList(new Colossus(), new ChargeSkillDefend(2, 0)),
					Arrays.asList(new Shove(), new Smite()),
					3,
					Weapon.Type.AXE);
		if(name.equals("Warrior"))
			return new Class("Warrior", 
					...
					0,
					Arrays.asList(new Colossus(), new ChargeSkillDefend(1, 0)),
					Arrays.asList(new Shove(), new Smite()),
					3,
		...
		if(name.equals("Assassin"))
			return new Class("Assassin", 
					...
					10,
					Arrays.asList(new Lethality(), new ChargeSkillDefend(2, 0)),
					Arrays.asList(new Shove()),
					8,
					Weapon.Type.SWORD);
		...
		if(name.equals("Sage"))
			return new Class("Sage", 
					...
					0,
					Arrays.asList(new Sol(true), new ChargeSkillDefend(1, 0)),
					Arrays.asList(new Shove()),
					3,
		...
		if(name.equals("General"))
			return new Class("General", 
					...
					0,
					Arrays.asList(new Pavise(), new ChargeSkillDefend(1, 0)),
					Arrays.asList(new Shove(), new Smite()),
					3,
		...
		if(name.equals("Valkyrie"))
			return new Class("Valkyrie", 
					...
					0,
					Arrays.asList(new Miracle(), new ChargeSkillDefend(1, 0)),
					emptyFieldSkillList,
					3,
		...
		if(name.equals("Swordmaster"))
			return new Class("Swordmaster",
					...
					20,
					Arrays.asList(new Astra(), new ChargeSkillDefend(3, 0)),
					Arrays.asList(new Shove()),
					3,
					Weapon.Type.SWORD);
		if(name.equals("Sorcerer"))
			return new Class("Sorcerer",
					...
					0,
					Arrays.asList(new Luna(true), new ChargeSkillDefend(1, 0)),
					Arrays.asList(new Shove()),
					3,
		...
		if(name.equals("Falconknight"))
			return new Class("Falconknight", 
					...
					0,
					Arrays.asList(new Crisis(), new ChargeSkillDefend(1, 0)),
					emptyFieldSkillList,
					3,
