...
public class PaletteSwapper {
	...
	static {
		String[] p = new String[] { "overworld", "general", "assassin", "berserker", "hero", "paladin", "sagem",
		        "sagef", "sniperm", "sniperf", "sorcerer", "swordmasterm", "swordmasterf", "valkyrie", "falconknight",
		        "phantom" };
		...
		lookup.put("paladin",
		        Arrays.asList(new String[] { "Cameron", "Sain", "Franz", "Forde", "Kyle", "Kent", "Lowen", "Marcus" }));
	...
	public static ShaderArgs setup(FightUnit u) {
		...
		if (unit.getUnitClass().name.equals("Lord"))
			return args;
